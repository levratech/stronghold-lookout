...
export const lookoutModules: LookoutModuleDefinition[] = [
  ...
  },
  {
    ...
    summary: "Account-owned identities and managed people shown as scope-bound operating roles rather than account-wide power.",
    surfaceLabel: "People Surface",
    entryHint: "Manage identities as scoped roles tied to scopes, not as global account permissions.",
  },
  {
    id: "contexts",
    name: "Scopes",
    ...
    icon: "CX",
    description: "Personal, organization, and child scopes available to the active identity.",
    status: "partial",
    requiredCapabilities: ["contexts:read"],
    summary: "Scopes I have access to.",
    surfaceLabel: "Scope Manager",
    entryHint: "Manage scopes available to the active identity.",
  },
  {
    id: "badges",
    name: "Access",
    ...
    icon: "AX",
    description: "Scope-scoped access labels built from badge definitions.",
    status: "partial",
    requiredCapabilities: ["badges:read"],
    summary: "Access labels inside scopes, backed by badge definitions and granted to specific identities.",
    surfaceLabel: "Access Surface",
    entryHint: "Manage access labels under a scope before assigning them to identities.",
  },
  {
    id: "grants",
  ...
  },
  {
    ...
    icon: "SV",
    description: "Service definitions, scope bindings, and permission lanes.",
    status: "partial",
    requiredCapabilities: ["services:read", "services:manage"],
    summary: "Diagnostic view of shared service bindings with scope, service-held keys, and badge-scoped lanes.",
    surfaceLabel: "Diagnostics Surface",
  ...
  },
  {
    ...
    entryHint: "Manage the public interface a domain or scope is reached through, not the scope authority itself.",
  },
  {
    id: "transport",
    name: "Transport",
