...
export const lookoutModules: LookoutModuleDefinition[] = [
  ...
  },
  {
    ...
    icon: "CX",
    description: "Personal, organization, and child spaces available to the active identity.",
    status: "partial",
    requiredCapabilities: ["contexts:read"],
    summary: "Spaces I have access to.",
    surfaceLabel: "Space Manager",
    entryHint: "Manage spaces available to the active identity.",
  },
  {
    id: "badges",
    name: "Access",
